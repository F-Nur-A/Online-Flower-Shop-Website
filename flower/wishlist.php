...
<section class="wishlist">
    ...
    <form action="" method="POST" class="box">
        ...
        <div class="price"><?php echo $fetch_wishlist['price']; ?> TL</div>
    ...
    $grand_total += $fetch_wishlist['price'];
        ...
        echo '<p class="empty">İstek listeniz boş</p>';
    }
    ?>
    </div>

    <div class="wishlist-total">
        <p>Toplam Tutar : <span><?php echo $grand_total; ?> TL</span></p>
        <a href="shop.php" class="option-btn">alışverişe devam et</a>
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('Bütün favorileriniz silinsin mi?');">Tümünü Sil</a>
    </div>
