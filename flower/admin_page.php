...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            $total_completes = 0;
            $select_completes = mysqli_query($conn, "SELECT * FROM `orders` WHERE payment_status = 'Tamamlandı'") or die('query failed');
      ...
      <div class="box">
         <?php
            $select_admin = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'yönetici'") or die('query failed');
