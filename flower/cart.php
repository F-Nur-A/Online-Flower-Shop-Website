...
<section class="shopping-cart">
    ...
    ?>
    <div  class="box">
        <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Sepetten silinsin mi?');"></a>
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('Sepetteki her şey silinsin mi?');">Tümünü Sil</a>
    </div>

    <div class="cart-total">
        <p>Sipariş Toplam Tutarı : <span><?php echo $grand_total; ?> TL</span></p>
        <a href="shop.php" class="option-btn">Alışverişe Devam Et</a>
        <a href="checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">Ödeme İşlemine geç</a>
    </div>
