...
<section class="users">
   ...
   <h1 class="title">KULLANICI HESAPLARI</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Kullanıcı Adı : <span><?php echo $fetch_users['name']; ?></span></p>
         <p>E-mail : <span><?php echo $fetch_users['email']; ?></span></p>
         <p>Kullanıcı Tipi : <span style="color:<?php if($fetch_users['user_type'] == 'yönetici'){ echo 'var(--orange)'; }; ?>"><?php echo $fetch_users['user_type']; ?></span></p>
